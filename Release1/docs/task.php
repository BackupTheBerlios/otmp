 ...
 * $Revision: 1.1 $
 * $Id: task.php,v 1.1 2001/12/16 22:47:16 hifix Exp $
 *
 * To Do:
 * - LOcalisation
...
function makeTask(&$frm) {
  ...
  // neuen Text anlegen
  $ntextid = sql_addNewText($frm['title'],nvl($frm['abstract']),0,$frm['lang'],nvl($frm['cat'],0),nvl($frm['filetyp'],0),$session['userid']); 
